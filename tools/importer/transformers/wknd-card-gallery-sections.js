 ...
 * for the card-gallery template.
 *
 * Inserts a section break (<hr>) before each non-first section (3 breaks for
 * 4 sections) and a "Section Metadata" block for each section that carries a
 * distinct style.
 *
 ...
 * section boundaries and styles from migration-work/card-gallery/page-structure.json
 * are embedded below. If a future page-templates.json populates
 * `payload.template.sections`, that takes precedence.
 *
 * Selectors verified against migration-work/card-gallery/cleaned.html
 * (main#main-content children: 1 header + 3 sections, lines 47-48):
 *  - rc1 header.secondary-section ... style: secondary (KEEP)
 *  - rc2 section#trends ............. default white (NO metadata)
 *  - rc3 section.secondary-section .. style: secondary (KEEP)
 *  - rc4 section.accent-section ..... style: accent (KEEP)
 */
...
const EMBEDDED_SECTIONS = [
  ...
  { id: 'rc2', selector: '#main-content > section.section#trends' },
