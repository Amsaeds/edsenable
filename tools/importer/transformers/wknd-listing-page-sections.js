 ...
 * the 4 sections) and a "Section Metadata" block for each section that carries
 * a distinct style.
 *
 ...
 * section boundaries and styles from migration-work/listing-page/
 * page-structure.json are embedded below. If a future page-templates.json
 * populates `payload.template.sections`, that takes precedence.
 *
 * Selectors verified against migration-work/listing-page/cleaned.html
 * (#main-content children: 1 header + 3 sections):
 *  - rc1 header.secondary-section ......... style: secondary
 *  - rc2 section:nth-of-type(1) ........... default white (no metadata)
 *  - rc3 #articles (section.secondary) .... style: secondary
...
const EMBEDDED_SECTIONS = [
  ...
  { id: 'rc3', selector: '#articles', style: 'secondary' },
